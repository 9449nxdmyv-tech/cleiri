        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="group">
              ...
              <p className="font-serif text-3xl md:text-4xl text-[var(--color-bone)] mb-1">93K</p>
            ...
            <div className="group">
              ...
              <p className="font-serif text-3xl md:text-4xl text-[var(--color-bone)] mb-1">37.2K</p>
            ...
            <div className="group">
              ...
              <p className="font-serif text-3xl md:text-4xl text-[var(--color-bone)] mb-1">35k</p>
            ...
            <div className="group">
              ...
              <p className="font-serif text-3xl md:text-4xl text-[var(--color-bone)] mb-1">740</p>
            ...
            >
              <div className="aspect-[3/4] relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-[var(--color-bone)] p-6">
                  ...
                  <p className="text-sm opacity-80 leading-relaxed text-center">
                    Watch episodes and behind the scenes
                  </p>
                </div>
              </div>
            </Link>
